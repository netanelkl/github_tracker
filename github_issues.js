...
// var current_req = URI.expand(project_page + issues).addSearch('access_token',
// access_token);
current_req = (project_page + issues + "?" + token_param).replace('{owner}',
		credentials.owner).replace('{project}', credentials.project).replace(
